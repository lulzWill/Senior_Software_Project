...
User.create(user_id: 'chuck', password: 'chuck2', email: 'b@b.com')
User.create(user_id: 'chuck', password: 'chuck3', email: 'c@b.com')
User.create(user_id: 'chuck', password: 'chuck4', email: 'd@b.com')
User.create(user_id: 'chuck', password: 'chuck5', email: 'e@b.com')
