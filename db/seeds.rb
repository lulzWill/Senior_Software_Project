...
User.create(user_id: 'chuck', password: 'chuck1', email: 'a@b.com', admin: true)
User.create(user_id: 'chuck1', password: 'chuck1', email: 'b@a.com', moderator: true)
...
Review.create(user_id:1, location_id:1, visit_id:1, rating:4, comment: 'test comment', allowed:true)
Visit.create(user_id:1, location_id:1, start_date: Date.new(2005,2,13), end_date: Date.new(2005,2,20))
Review.create(user_id:1, location_id:1, visit_id:2, rating:1, comment: 'another test', allowed:true)
